...
export class ChartJs extends Component {
    ...
    areaData = {
        ...
        datasets: [{
          label: 'Уровень релевантности угроз',
          data: [22, 28, 31, 43, 39, 48],
          backgroundColor: [
            'rgba(255, 99, 132, 0.2)',
            'rgba(54, 162, 235, 0.2)',
            'rgba(255, 206, 86, 0.2)',
            ...
            <div>
                <div className="page-header">
                    ...
                    <nav aria-label="breadcrumb">
                        ...
                        <li className="breadcrumb-item"><a href="!#" onClick={event => event.preventDefault()}>Метрики риска</a></li>
                    ...
                    <div className="col-md-6 grid-margin stretch-card">
                        <div className="card">
                            <div className="card-body">
                                <h4 className="card-title">Сигналы по дням</h4>
