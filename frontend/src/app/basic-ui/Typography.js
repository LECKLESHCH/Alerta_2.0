...
class Typography extends Component {
  ...
  async loadNews() {
    ...
    try {
      ...
      this.setState({
        isLoadingNews: false,
        newsError: error.message || 'Не удалось загрузить новостные статьи.',
      });
    }
  }
  ...
  toggleArticle = (articleId) => {
    this.setState((prevState) => ({
      openedArticleId: prevState.openedArticleId === articleId ? null : articleId,
  ...
  renderSourceDropdown({ selectedSourcesLabel, sourceOptions, isInteractive }) {
    return (
              ...
              <div className="form-check mb-2" key={source}>
                <label className="form-check-label alerta-filter-option">
                  <input
                    ...
                    checked={this.state.selectedSources.includes(source)}
    ...
    return (
      <div>
        <div className="page-header">
          <h3 className="page-title">Новостные статьи</h3>
        ...
        <div className="row">
          {this.renderNewsDatabaseCard({
            ...
            placeholder: 'Новостные статьи пока не загружены.',
